...
public class SolYSombraBlackTile extends Actor {
    ...
    public SolYSombraBlackTile(Texture texture, int[] array, int index){
        tileTexture = texture;
        this.array = array;
        this.index = index;

        array[index] = 1; //Put the number 1 (corresponding to the black tab) in the position of the corresponding array
